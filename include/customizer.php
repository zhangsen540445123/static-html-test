...
function cryptocurrency_exchange_customize_register( $wp_customize ) {
	...
	class cryptocurrency_exchange_More_Control extends WP_Customize_Control {
		...
		*/
		...
		$wp_customize->add_section( 'cryptocurrency_general_option' , array(
				'title'      	=> __( 'HomePage General Settings', 'cryptocurrency-exchange' ),
				//'description'   => __('', 'cryptocurrency-exchange'),
				'priority'      => 2,
				'panel'      	=> 'cryptocurrency_exchange_theme_options',
			) 
		);
			...
			//Enable Read More into blog post			
			$wp_customize->add_setting( 'cryptocurrency_exchange_readmore_general', array(
					'default'      		=> 'inactive',
					'sanitize_callback' => 'cryptocurrency_exchange_sanitize_radio'
				)
			);
			$wp_customize->add_control('cryptocurrency_exchange_readmore_general', array(
					'type'      => 'radio',
					'label'     => __('Read More Button for Blog', 'cryptocurrency-exchange'),
					'section'   => 'cryptocurrency_general_option',
					'priority'  => 1,
					'choices'   => array(
		...
		$wp_customize->add_section( 'cryptocurrency_service_option' , array(
			...
			//link 1
			$wp_customize->add_setting('cryptocurrency_exchange_service_link_1', array(
					'default' 			=> esc_html('','cryptocurrency-exchange'),
					'sanitize_callback' => 'esc_url'
				)
			);
			$wp_customize->add_control('cryptocurrency_exchange_service_link_1', array(
					'label' 	=> __( 'Link 1', 'cryptocurrency-exchange' ),
					'section' 	=> 'cryptocurrency_service_option',
					'type' 		=> 'url',
					'priority' 	=> 5,
					'active_callback' => 'cryptocurrency_exchange_service_callback',
			...
			//link 2
			$wp_customize->add_setting('cryptocurrency_exchange_service_link_2', array(
					'default' 			=> esc_html('','cryptocurrency-exchange'),
					'sanitize_callback' => 'esc_url'
				)
			);
			$wp_customize->add_control('cryptocurrency_exchange_service_link_2', array(
					'label' 	=> __( 'Link 2', 'cryptocurrency-exchange' ),
					'section' 	=> 'cryptocurrency_service_option',
					'type' 		=> 'url',
					'priority' 	=> 10,
					'active_callback' => 'cryptocurrency_exchange_service_callback',
			...
			//link 3
			$wp_customize->add_setting('cryptocurrency_exchange_service_link_3', array(
					'default' 			=> esc_html('','cryptocurrency-exchange'),
					'sanitize_callback' => 'esc_url'
				)
			);
			$wp_customize->add_control('cryptocurrency_exchange_service_link_3', array(
					'label' 	=> __( 'Link 3', 'cryptocurrency-exchange' ),
					'section' 	=> 'cryptocurrency_service_option',
					'type' 		=> 'url',
					'priority' 	=> 15,
					'active_callback' => 'cryptocurrency_exchange_service_callback',
			...
			function cryptocurrency_exchange_service_callback( $cryptocurrency_service_control ) {
				...
				if ( $cryptocurrency_service_control_id == 'cryptocurrency_exchange_service_link_1'  && $cryptocurrency_service_radio_setting == 'active' ) return true;
				//service two			
				...
				if ( $cryptocurrency_service_control_id == 'cryptocurrency_exchange_service_link_2'  && $cryptocurrency_service_radio_setting == 'active' ) return true;
				//service three
				...
				if ( $cryptocurrency_service_control_id == 'cryptocurrency_exchange_service_link_3'  && $cryptocurrency_service_radio_setting == 'active' ) return true;
